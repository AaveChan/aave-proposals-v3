 ...
 */
contract AaveV3Plasma_OnboardXPLOnAaveV3PlasmaInstance_20251027 is AaveV3PayloadPlasma {
  using SafeERC20 for IERC20;

  address public constant WXPL = 0x6100E367285b01F48D07953803A2d8dCA5D19873;
  uint256 public constant WXPL_SEED_AMOUNT = 300e18;
    ...
    returns (IAaveV3ConfigEngine.EModeCategoryCreation[] memory)
  {
    ...
    address[] memory collateralAssets_WPXL__Stablecoins = new address[](1);
    address[] memory borrowableAssets_WPXL__Stablecoins = new address[](2);

    collateralAssets_WPXL__Stablecoins[0] = WXPL;
    borrowableAssets_WPXL__Stablecoins[0] = AaveV3PlasmaAssets.USDT0_UNDERLYING;
    borrowableAssets_WPXL__Stablecoins[1] = AaveV3PlasmaAssets.GHO_UNDERLYING;
    ...
    eModeCreations[0] = IAaveV3ConfigEngine.EModeCategoryCreation({
      ...
      collaterals: collateralAssets_WPXL__Stablecoins,
      borrowables: borrowableAssets_WPXL__Stablecoins
    });
